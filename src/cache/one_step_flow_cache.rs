...
mod test {
    ...
    mod test_none_or_error {
        ...
        fn get_none() {
            ...
            // this will call mocker
            let result = OneStepFlowCacheImpl::get(&from, rtn_none);
    ...
    mod test_group_and_weight {
        ...
        fn only_one_group_for_a_given_target() {
            ...
            fn rtn_one(_: &Meta) -> RelationResult {
                Ok(Some(vec![
            ...
            // this will call mocker
            let result = OneStepFlowCacheImpl::get(&from, rtn_one);
        ...
        fn same_group_different_target() {
            ...
            fn rtn_some(_: &Meta) -> RelationResult {
                Ok(Some(vec![
            ...
            // this will call mocker
            let result = OneStepFlowCacheImpl::get(&from, rtn_some);
            let result = result.unwrap().unwrap();
            assert_eq!(result.len(), 1);
            // and the repeated call will not call mocker but get from cache
            let result = OneStepFlowCacheImpl::get(&from, rtn_none);
